...
# Conclusion
The accounts identified during this research represent a very small subset of inauthentic personas whose purpose is to amplify extremist and divisive content on the platform. The actions of this group of users are a detriment to society and are contributing to social health problems, such as the January 6th attack on the US Capitol building and riots related to the refusal of the COVID-19 vaccine. The group's high-volume activity directly contributes to the amplification of content designed to cause societal divide, spread harmful disinformation, and recruit new extremists. The mechanisms they use are not new, and many of the accounts identified in this research have likely been participating in this activity for years. The lists of Twitter account ids provided in this repo represent a starting point for analysis of this group as a whole. The contributors to this research hope that Twitter's Safety team perform such an analysis and take appropriate actions to curb these mechanisms once and for all.
